...
- Hardened build signing to handle intermittent xattr metadata contamination.
...
- Added a GitHub bug-report template requiring a diagnostic report and offering optional diagnostic-file attachment guidance.
